...
class MyApp(wx.App):
    def __init__(self):
        ...
        frame = wx.Frame(parent=None, title='数据库字典生成工具V1.0', size=(420, 340))
    ...
    def on_generate(self, event):
        ...
        if host and port and user and psw and database:
            ...
            if dialog.ShowModal() == wx.ID_OK:
                ...
                f = open(xlsFilePath, 'w', encoding='utf8')
                f.write(result)
                f.close()
